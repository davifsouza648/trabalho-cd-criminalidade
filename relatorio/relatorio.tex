...
A mesma informação no mapa (Figura~\ref{fig:mapa}) torna o padrão espacial
imediato: a região Metropolitana de Porto Alegre e o Centro Ocidental são as mais
intensas, e o Centro Oriental, no coração do estado, a menos. A malha geográfica
foi obtida da API de malhas do IBGE.
